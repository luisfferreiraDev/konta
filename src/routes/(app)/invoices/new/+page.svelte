...
<Container>
	...
	>
		<div class="space-y-6 rounded-lg glass p-6">
			<!-- Client & Currency -->
			...
			<div class="grid grid-cols-1 gap-6 md:grid-cols-3">
				...
				<div>
					<label for="taxRate" class="block text-sm font-medium text-primary">
						Default Tax Rate (%) <span class="text-xs text-secondary">blank = 0%</span>
					</label>
					<input
						type="number"
						id="taxRate"
			...
			<div>
				<div class="mb-3 flex items-center justify-between">
					<h3 class="text-base font-semibold text-primary">Line Items</h3>
					<Button size="sm" onclick={addLineItem}>Add Line Item</Button>
				</div>
			...
			{#if data.org.customFieldDefs.length > 0}
				<div>
					<h3 class="mb-3 text-base font-semibold text-primary">Custom Fields</h3>
		...
		<div class="flex items-center justify-end gap-3">
			<Button variant="secondary" href={routes.invoices.list()}>Cancel</Button>
